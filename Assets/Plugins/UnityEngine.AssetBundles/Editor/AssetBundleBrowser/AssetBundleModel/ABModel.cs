...
namespace UnityEngine.AssetBundles.AssetBundleModel
{
    public class Model
    {
        ...
        public static BundleFolderConcreteInfo m_RootLevelBundles = new BundleFolderConcreteInfo("", null);
        private static List<ABMoveData> m_MoveData = new List<ABMoveData>();
        public static List<BundleInfo> m_BundlesToUpdate = new List<BundleInfo>();
